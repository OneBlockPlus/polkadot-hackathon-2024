...
import { RococoContractsTestnet, RococoTestnet, ShibuyaTestnet, Astar, Phala, Aleph, AlephTestnet } from 'useink/chains';
  ...
  return (
    <UseInkProvider
      config={{
        ...
        chains: [RococoContractsTestnet, RococoTestnet, ShibuyaTestnet, Astar, Phala, Aleph, AlephTestnet],
        caller: {
