...
pub use self::augmea_stablecoin::{AugmeaStablecoin, AugmeaStablecoinRef};

#[ink::contract]
mod augmea_stablecoin 
{
    
    /////"dataImports"//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    #[ink(storage)]
    pub struct AugmeaStablecoin 
    {
        liquid_stablecoin_vault_address: AccountId,
    ...
    impl AugmeaStablecoin 
    {
        ...
        pub fn new(param_name: String, param_symbol: String) -> Self 
        {
            ...
            Self {liquid_stablecoin_vault_address: AccountId::from([0x42; 32]), balances: empty_mapping, allowances: empty_mapping_2, decimals: _decimals, name: param_name, symbol: param_symbol}
        }
        ...
        ////////////////////////////////////////////////////////////////////////////
        #[ink[message]]
        pub fn set_liquid_stablecoin_vault_address(&mut self, param_liquid_stablecoin_vault_address: AccountId)
        {
            self.liquid_stablecoin_vault_address = param_liquid_stablecoin_vault_address;
        }
        ...
        pub fn mint_tokens(&mut self, param_address_to_mint: AccountId ,param_quantity: u128)
        {
            ...
            assert!(caller == self.liquid_stablecoin_vault_address, "Caller not vault.");
