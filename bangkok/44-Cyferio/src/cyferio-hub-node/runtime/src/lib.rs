...
use sp_runtime::{
	...
	traits::{BlakeTwo256, Block as BlockT, Extrinsic, IdentifyAccount, NumberFor, One, Verify},
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("cyferio-hub-runtime"),
	impl_name: create_runtime_str!("cyferio-hub-runtime"),
	authoring_version: 1,
