...
use frame_support::{traits::EnsureOrigin, weights::{
...
mod runtime {
	...
	pub type Reserve = pallet_reserve;
	// #[runtime::pallet_index(52)]
...
impl common::AssetMetadataTrait<RuntimeOrigin, AssetId> for pallet_assets::Pallet<Runtime> {
	fn set_metadata(origin: RuntimeOrigin, id: AssetId, name: Vec<u8>, symbol: Vec<u8>, decimals: u8) -> DispatchResult {
		pallet_assets::Pallet::<Runtime>::force_set_metadata(origin, id.into(), name, symbol, decimals, false)
	}
}
