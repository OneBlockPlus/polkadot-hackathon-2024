...
export class Initial1692350473907 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "drip" ("id" SERIAL NOT NULL, "timestamp" BIGINT NOT NULL DEFAULT now(), "usernameSha256" character varying, "addressSha256" character varying NOT NULL, CONSTRAINT "PK_869cd028514a4d3cd3e359d3844" PRIMARY KEY ("id"))`,
    );
