...
export const themes: CustomFlowbiteTheme = {
    ...
    pagination: {
        ...
        "pages": {
            ...
            "previous": {
                "base": "ml-0 rounded-l-lg border border-gray-300 bg-white px-3 py-2 leading-tight text-gray-500 enabled:hover:opacity-80 enabled:hover:text-gray-700 dark:border-gray-700 dark:bg-border-color dark:text-gray-400 enabled:dark:hover:opacity-80 enabled:dark:hover:text-white",
                "icon": "h-5 w-5"
            },
            "next": {
                "base": "rounded-r-lg border border-gray-300 bg-white px-3 py-2 leading-tight text-gray-500 enabled:hover:opacity-80 enabled:hover:text-gray-700 dark:border-gray-700 dark:bg-border-color dark:text-gray-400 enabled:dark:hover:opacity-80 enabled:dark:hover:text-white",
                "icon": "h-5 w-5"
            },
            "selector": {
                "base": "w-12 border border-gray-300 bg-white py-2 leading-tight text-gray-500 enabled:hover:opacity-80 enabled:hover:text-gray-700 dark:border-gray-700 dark:bg-border-color dark:text-gray-400 enabled:dark:hover:opacity-80 enabled:dark:hover:text-white",
                "active": "bg-cyan-50 text-cyan-600 hover:bg-cyan-100 hover:text-cyan-700 dark:border-gray-700 dark:bg-accent-color dark:text-white",
                "disabled": "cursor-not-allowed opacity-50"
            }
        }
    }
