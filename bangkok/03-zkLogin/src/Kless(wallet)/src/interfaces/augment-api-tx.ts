...
import type { SpConsensusGrandpaEquivocationProof, SpCoreVoid, SpWeightsWeightV2Weight, ZkloginSupportZkMaterial } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    zkLogin: {
      /**
       * See [`Pallet::submit_zklogin_unsigned`].
       **/
      submitZkloginUnsigned: AugmentedSubmittable<(uxt: Bytes | string | Uint8Array, addressSeed: MultiAddress | { Id: any } | { Index: any } | { Raw: any } | { Address32: any } | { Address20: any } | string | Uint8Array, zkMaterial: ZkloginSupportZkMaterial | { source?: any; inputs?: any; ephkeyExpireAt?: any; ephPubkey?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, MultiAddress, ZkloginSupportZkMaterial]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
