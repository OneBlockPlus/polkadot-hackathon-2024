...
export default {
  ...
  /**
   * Lookup38: pallet_zklogin::pallet::Event<T>
   **/
  PalletZkloginEvent: {
    _enum: {
      ZkLoginExecuted: {
  ...
  /**
   * Lookup112: pallet_zklogin::pallet::Call<T>
   **/
  PalletZkloginCall: {
    _enum: {
      submit_zklogin_unsigned: {
        uxt: 'Bytes',
        addressSeed: 'MultiAddress',
        zkMaterial: 'ZkloginSupportZkMaterial'
      }
    }
  },
  /**
  ...
  /**
   * Lookup121: frame_system::extensions::check_non_zero_sender::CheckNonZeroSender<T>
   **/
  FrameSystemExtensionsCheckNonZeroSender: 'Null',
  /**
   * Lookup122: frame_system::extensions::check_spec_version::CheckSpecVersion<T>
   **/
  FrameSystemExtensionsCheckSpecVersion: 'Null',
  /**
   * Lookup123: frame_system::extensions::check_tx_version::CheckTxVersion<T>
   **/
  FrameSystemExtensionsCheckTxVersion: 'Null',
  /**
   * Lookup124: frame_system::extensions::check_genesis::CheckGenesis<T>
   **/
  FrameSystemExtensionsCheckGenesis: 'Null',
  /**
   * Lookup127: frame_system::extensions::check_nonce::CheckNonce<T>
   **/
  FrameSystemExtensionsCheckNonce: 'Compact<u32>',
  /**
   * Lookup128: frame_system::extensions::check_weight::CheckWeight<T>
   **/
  FrameSystemExtensionsCheckWeight: 'Null',
  /**
   * Lookup129: pallet_transaction_payment::ChargeTransactionPayment<T>
   **/
  PalletTransactionPaymentChargeTransactionPayment: 'Compact<u128>',
  /**
   * Lookup130: zklogin_support::ZkMaterial
   **/
  ZkloginSupportZkMaterial: {
    source: 'ZkloginSupportJwkJwkId',
    inputs: 'ZkloginSupportZkInputZkLoginInputs',
    ephkeyExpireAt: 'u32',
    ephPubkey: '[u8;32]'
  },
  /**
   * Lookup131: zklogin_support::jwk::JwkId
   **/
  ZkloginSupportJwkJwkId: {
    provider: 'ZkloginSupportJwkJwkProvider',
    kid: 'Bytes'
  },
  /**
   * Lookup132: zklogin_support::jwk::JWKProvider
   **/
  ZkloginSupportJwkJwkProvider: {
    _enum: ['Google', 'Twitch', 'Facebook', 'Kakao', 'Apple', 'Slack']
  },
  /**
   * Lookup134: zklogin_support::zk_input::ZkLoginInputs
   **/
  ZkloginSupportZkInputZkLoginInputs: {
    proofPoints: 'ZkloginSupportZkInputZkLoginProof',
    issBase64Details: 'ZkloginSupportZkInputClaim',
    header: 'U256'
  },
  /**
   * Lookup135: zklogin_support::zk_input::ZkLoginProof
   **/
  ZkloginSupportZkInputZkLoginProof: {
    a: '[U256;3]',
    b: '[[U256;2];3]',
    c: '[U256;3]'
  },
  /**
   * Lookup141: zklogin_support::zk_input::Claim
   **/
  ZkloginSupportZkInputClaim: {
    value: 'U256',
    indexMod4: 'u8'
  },
  /**
   * Lookup142: pallet_zklogin::pallet::Error<T>
   **/
  PalletZkloginError: {
    _enum: ['EphKeyExpired', 'InvalidTransaction', 'UnknownTransactionCannotLookup', 'UnknownTransactionNoUnsignedValidator', 'UnknownTransactionCustom']
  },
  /**
