...
pub mod messaging {
	...
	pub use pfx_mq::{bind_topic, types::*};

	bind_topic!(WorkerEvent, b"pflx/teeworker/event");
	#[derive(Encode, Decode, Debug, TypeInfo)]
	pub enum WorkerEvent {
		/// pfx-pallet-tee-worker --> worker
	...
	bind_topic!(MasterKeyLaunch, b"pflx/masterkey/launch");
	...
	bind_topic!(MasterKeyDistribution, b"pflx/masterkey/dist");
	#[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
	...
	bind_topic!(MasterKeyApply, b"pflx/masterkey/apply");
	#[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
