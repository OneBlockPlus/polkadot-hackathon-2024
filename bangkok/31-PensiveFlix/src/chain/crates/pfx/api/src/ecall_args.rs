...
pub struct InitArgs {
    ...
    /// The Pflix persistent data storing path
    ...
    /// Number of cores used to run pflix service
    pub cores: u32,
    ...
    /// Only sync blocks into pflix without dispatching messages.
    ...
    /// The type of pflix's remote attestation method,None means epid.
