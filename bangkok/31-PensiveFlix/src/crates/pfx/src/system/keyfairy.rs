use super::master_key::PflixMasterKey;
use pfx_crypto::{
    aead, key_share,
    rsa::RsaDer,
...
use pfx_mq::{traits::MessageChannel, Sr25519Signer};
use pfx_types::{
...
{
    pub fn new(master_key: PflixMasterKey, egress: MsgChan) -> Self {
    ...
    pub fn master_key(&self) -> &PflixMasterKey {
        &self.master_key
    }
