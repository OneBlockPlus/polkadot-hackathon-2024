...
impl crate::crpc::InitRuntimeRequest {
    ...
    pub fn decode_attestation_provider(
        &self,
    ) -> Result<Option<pfx_types::AttestationProvider>, ScaleDecodeError> {
    ...
    pub fn new(
        ...
        attestation_provider: Option<pfx_types::AttestationProvider>,
...
impl crate::crpc::InitRuntimeResponse {
    pub fn decode_runtime_info(
        &self,
    ) -> Result<pfx_types::WorkerRegistrationInfo<chain::AccountId>, ScaleDecodeError> {
    ...
    pub fn decode_public_key(&self) -> Result<pfx_types::WorkerPublicKey, ScaleDecodeError> {
        Decode::decode(&mut &self.encoded_public_key[..])
    }
    pub fn decode_ecdh_public_key(&self) -> Result<pfx_types::EcdhPublicKey, ScaleDecodeError> {
        Decode::decode(&mut &self.encoded_ecdh_public_key[..])
    }
    pub fn new(
        runtime_info: pfx_types::WorkerRegistrationInfo<chain::AccountId>,
        genesis_block_hash: chain::Hash,
        public_key: pfx_types::WorkerPublicKey,
        ecdh_public_key: pfx_types::EcdhPublicKey,
...
impl crate::crpc::HandoverChallenge {
    pub fn decode_challenge(
        &self,
    ) -> Result<pfx_types::HandoverChallenge<chain::BlockNumber>, ScaleDecodeError> {
        Decode::decode(&mut &self.encoded_challenge[..])
    }
    pub fn new(challenge: pfx_types::HandoverChallenge<chain::BlockNumber>) -> Self {
        Self {
...
impl crate::crpc::HandoverChallengeResponse {
    pub fn decode_challenge_handler(
        &self,
    ) -> Result<pfx_types::ChallengeHandlerInfo<chain::BlockNumber>, ScaleDecodeError> {
        Decode::decode(&mut &self.encoded_challenge_handler[..])
    }
    pub fn new(
        challenge_handler: pfx_types::ChallengeHandlerInfo<chain::BlockNumber>,
        attestation: Option<Attestation>,
    ) -> Self {
        Self {
...
impl crate::crpc::HandoverWorkerKey {
    pub fn decode_worker_key(&self) -> Result<pfx_types::EncryptedWorkerKey, ScaleDecodeError> {
        Decode::decode(&mut &self.encoded_worker_key[..])
    }
    pub fn new(
        worker_key: pfx_types::EncryptedWorkerKey,
        attestation: Option<Attestation>,
    ) -> Self {
        Self {
...
impl crate::crpc::GetEndpointResponse {
    pub fn decode_endpoint_payload(
        &self,
    ) -> Result<Option<pfx_types::WorkerEndpointPayload>, ScaleDecodeError> {
    ...
    pub fn new(
        endpoint_payload: Option<pfx_types::WorkerEndpointPayload>,
...
impl crate::crpc::GetMasterKeyApplyResponse {
    pub fn decode_payload(
        &self,
    ) -> Result<Option<pfx_types::MasterKeyApplyPayload>, ScaleDecodeError> {
    ...
    pub fn new(
        payload: pfx_types::MasterKeyApplyPayload,
