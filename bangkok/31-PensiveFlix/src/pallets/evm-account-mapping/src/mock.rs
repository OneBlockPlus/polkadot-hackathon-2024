...
use crate as pfx_pallet_evm_account_mapping;
use frame_support::{
	derive_impl,
	dispatch::DispatchClass,
	pallet_prelude::*,
	parameter_types,
	traits::{fungible::Mutate, ConstU128, ConstU16, ConstU32, ConstU64, Get, Imbalance, OnUnbalanced},
...
frame_support::construct_runtime!(
	pub struct Test {
		...
		EvmAccountMapping: pfx_pallet_evm_account_mapping,
	}
);
...
impl pfx_pallet_evm_account_mapping::Config for Test {
	type RuntimeEvent = RuntimeEvent;
	type RuntimeCall = RuntimeCall;
