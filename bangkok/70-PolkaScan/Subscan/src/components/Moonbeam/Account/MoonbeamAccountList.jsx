...
function MoonbeamAccountList() {
    ...
    const fetchAccounts = () => {
        ...
        const config = {
            method: "post",
            url: "https://moonbeam.api.subscan.io/api/v2/scan/accounts",
            headers: {
    ...
    return (
        <div className="p-5 ">
            <h2 className="text-2xl font-bold mb-4 text-pink-500">Moonbeam Account List</h2>
...
export default MoonbeamAccountList;
