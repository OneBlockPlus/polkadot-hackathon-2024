...
function MoonbeamBalanceHistory() {
    ...
    const fetchBalanceHistory = () => {
        ...
        const config = {
            method: "post",
            url: "https://moonbeam.api.subscan.io/api/scan/account/balance_history",
            headers: {
    ...
    return (
        <div className="p-5">
            <h2 className="text-2xl font-bold mb-4 text-pink-500">Moonbeam Balance History</h2>

            {/* Input for the address */}
            <input
                type="text"
                placeholder="Enter Moonbeam Address"
                value={address}
...
export default MoonbeamBalanceHistory;