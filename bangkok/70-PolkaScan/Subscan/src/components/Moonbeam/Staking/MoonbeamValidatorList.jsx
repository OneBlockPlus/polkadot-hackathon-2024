...
function MoonbeamValidatorList() {
    ...
    const fetchValidatorData = () => {
        ...
        const config = {
            method: 'post',
            url: 'https://moonbeam.api.subscan.io/api/scan/staking/validators',
            headers: { 
                        ...
                        {validatorData.map((validator, index) => (
                            <li key={index} className="border-b py-2">
                                <h4 className="font-semibold">
                                    {validator.controller_account_display ? validator.controller_account_display.display : 'N/A'}
                                </h4>
...
export default MoonbeamValidatorList;
