...
class CustomButton extends HTMLElement {
    ...
    <div class="com-main-mint">
        <img class="switch" id="switch" width="36" height="20" src="img/Switch-0.png" />
        <div class="con0" id="con0">
            <div class="t1">
                <i>$</i>
                <span>52,323<font>.43</font></span>
            </div>
            <div class="t2">
        ...
        store.get("sendMessage").then(data => {
            if (data?.content?.sourMessage == "mint") {
                isMinting=true;
                switchChange();
                startMint();
        ...
        switchBtn.addEventListener('click', switchChange);
        const startMint = () => {
            if (isShow) {
