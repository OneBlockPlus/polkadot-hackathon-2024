...
var polkadot_collectives_exports = {};
__export(polkadot_collectives_exports, {
  chainSpec: () => chainSpec
});
module.exports = __toCommonJS(polkadot_collectives_exports);
var chainSpec = `{
  "name": "Collectives",
...
`;
//# sourceMappingURL=polkadot_collectives.cjs.map