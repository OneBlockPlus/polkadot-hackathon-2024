...
var ksmcc3_asset_hub_exports = {};
__export(ksmcc3_asset_hub_exports, {
  chainSpec: () => chainSpec
});
module.exports = __toCommonJS(ksmcc3_asset_hub_exports);
var chainSpec = `{
...
`;
//# sourceMappingURL=ksmcc3_asset_hub.cjs.map