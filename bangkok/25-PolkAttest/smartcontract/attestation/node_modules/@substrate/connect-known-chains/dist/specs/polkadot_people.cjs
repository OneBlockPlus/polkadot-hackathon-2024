...
var polkadot_people_exports = {};
__export(polkadot_people_exports, {
  chainSpec: () => chainSpec
});
module.exports = __toCommonJS(polkadot_people_exports);
var chainSpec = `{
...
`;
//# sourceMappingURL=polkadot_people.cjs.map