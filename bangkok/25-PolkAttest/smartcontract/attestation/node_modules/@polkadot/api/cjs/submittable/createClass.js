...
function createClass({ api, apiType, blockHash, decorateMethod }) {
    ...
    class Submittable extends ExtrinsicBase {
        ...
        __internal__transformResult = (util_1.identity);
        ...
        __internal__observeSubscribe = (info) => {
            ...
            return api.rpc.author.submitAndWatchExtrinsic(info?.signedTransaction || this).pipe((0, rxjs_1.switchMap)((status) => this.__internal__observeStatus(txHash, status)), (0, rxjs_1.tap)((status) => {
