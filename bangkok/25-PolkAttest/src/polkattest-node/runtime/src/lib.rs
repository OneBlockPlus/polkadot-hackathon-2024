...
/// Import the attestations pallet.
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("polkattest-runtime"),
    impl_name: create_runtime_str!("polkattest-runtime"),
    authoring_version: 1,
    spec_version: 1,
    impl_version: 0,
...
mod runtime {
    ...
    // Include the custom logic from the pallet-attestations in the runtime.
