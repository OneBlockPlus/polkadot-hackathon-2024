...
/// Configure the credit_score in pallets/template.
impl credit_score::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
	type WeightInfo = credit_score::weights::SubstrateWeight<Runtime>;
	type AuthorityId = credit_score::crypto::TestAuthId;
...
mod runtime {
	...
	pub type CreditScore = credit_score;
