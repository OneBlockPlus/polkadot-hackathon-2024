    ...
    return (
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            className="h-12 min-w-[3rem] gap-2 rounded-2xl border border-white/10 bg-primary px-4 py-3 font-bold text-foreground md:min-w-[14rem]"
        ...
        <DropdownMenuContent className="min-w-[3rem] md:min-w-[14rem]">
          {!activeAccount &&
  ...
  return (
    <div className="flex select-none flex-wrap items-stretch justify-center gap-4">
      ...
      <DropdownMenu>
        ...
        >
          <Button
            className="min-w-[3rem] border md:min-w-[14rem]"
            translate="no"
          >
      ...
      {reducibleBalanceFormatted !== undefined && (
        <div className="flex min-w-[10rem] items-center justify-center gap-2 rounded-2xl border bg-gray-900 px-4 py-3 font-mono text-sm font-bold text-foreground max-md:hidden">
...
export const AccountName: FC<AccountNameProps> = ({ account, ...rest }) => {
  ...
  return (
    <div
      className="flex items-center gap-2 font-mono text-sm font-bold uppercase"
      {...rest}
    >
