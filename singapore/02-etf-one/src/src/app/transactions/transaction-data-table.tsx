...
import {  tableColumns } from '@/app/transactions/columns'
import { NewTxnButton } from '@/app/transactions/new-txn-button'
import { Transaction } from '@/generated/public/Transaction'
import { Wallet } from '@/generated/public/Wallet'
import { usePolkadotSender } from '@/lib/use-polkadot'
...
export function TransactionDataTable({
  ...
  const columns = tableColumns(sender)
  ...
  return (
    <div className="w-full">
      <div className="flex items-center py-4">
        ...
        <NewTxnButton wallets={wallets} setWallet={setWallet} />
      </div>
