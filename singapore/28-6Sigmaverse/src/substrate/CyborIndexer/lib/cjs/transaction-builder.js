...
var payloadMethod = require('./utils/payload-method.js');
...
class TransactionBuilder {
    ...
    async calculateGas(allowOtherPanics = false, increaseGas = 0) {
        ...
        const source = api.decodeAddress(typeof this._account === 'string' ? this._account : this._account.address);
        switch (this._tx.method.method) {
            case 'uploadProgram': {
        ...
        return {
            ...
            response: async (rawResult = false) => {
                ...
                return this._registry
                    .createType(`(String, String, ${this._responseType})`, message.payload)[2][payloadMethod.getPayloadMethod(this._responseType)]();
            },
        };
    }
}
